...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/styles-merged.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/style.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/custom.css')); ?>">

    <!--[if lt IE 9]>
    <script src='<?php echo e(asset("js/vendor/html5shiv.min.js")); ?>'></script>
...
<header role="banner" class="probootstrap-header">
    <div class="container">
        <a href="/" class="probootstrap-logo"><img style = "width:50px;" src="<?php echo e(asset("img/logo.png")); ?>"><span>вижение</span></a>
...
<div class="probootstrap-main-content">
    <section class="probootstrap-slider flexslider">
        <ul class="slides">
            <!-- class="overlay" -->
            <li style="background-image: url(<?php echo e(asset("img/slider_1.jpg")); ?>);">
                <div class="container">
                    <div class="row">
            ...
            <!-- class="overlay" -->
            <!-- class="overlay" -->
            <li style="background-image: url(<?php echo e(asset("img/slider_2.jpg")); ?>);">
                <div class="container">
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="probootstrap-slider-text text-center">
    ...
    <section class="probootstrap-half">
        <div class="image-wrap">
            <div class="image" style="background-image: url(<?php echo e(asset("img/slider_7.jpg")); ?>);"></div>
        </div>
        <div class="text">
    ...
    <section class="probootstrap-half reverse">
        <div class="image-wrap">
            <div class="image" style="background-image: url(<?php echo e(asset("img/slider_6.jpg")); ?>);"></div>
        </div>
        <div class="text">
    ...
    <section class="probootstrap-half">
        <div class="image-wrap">
            <div class="image" style="background-image: url(<?php echo e(asset("img/slider_2.jpg")); ?>);"></div>
        </div>
        <div class="text">
                    ...
                    <div class="owl-carousel owl-carousel-testimony owl-carousel-fullwidth mt50">
                        <div class="item">
                            ...
                            <div class="probootstrap-testimony-wrap">
                                <figure>
                                    <img src="<?php echo e(asset("img/person_1.jpg")); ?>" alt="Free Bootstrap Template by uicookies.com">
                                </figure>
